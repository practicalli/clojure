...
[Practicalli Clojure CLI Config](/clojure/install/clojure-cli/#practicalli-clojure-cli-config) extends the feautres of Clojure CLI, defining aliases that add community libraries and tools.
...
The Clojure CLI has several built-in tasks.  Additional tasks are provided via aliases that include libraries and tools from the Clojure community, e.g. [Practicalli Clojure CLI Config](/clojure/install/clojure-cli/#practicalli-clojure-cli-config)
...
A Clojure CLI user configuration is available to all projects by the operating system user account.  [Practicalli Clojure CLI Config](/clojure/clojure-cli/practicalli-config.md) is a user configuration that contains a set of well-formed aliases that adds common tools for any Clojure project.

...
* [Iterate over data structures](iterate-over-data-structures/index.md)
    * [reduce](iterate-over-data-structures/reduce.md)
    * [apply](iterate-over-data-structures/apply.md)
    * [map](iterate-over-data-structures/map.md)
    * [map annonymous function](iterate-over-data-structures/map-annonymous-function.md)
    * [map partial](iterate-over-data-structures/map-partial.md)

...
* [Getting Started](getting-started/index.md)
    ...
    * [Editor Install](getting-started/install-guides/index.md)
        * [Atom ProtoREPL](getting-started/install-guides/atom-protorepl.md)
        * [Atom Proton](getting-started/install-guides/atom-proton.md)
        * [Emacs Spacemacs](getting-started/install-guides/emacs-spacemacs.md)
        * [VSCode Calva](getting-started/install-guides/vscode-calva.md)
        * [IntelliJ Cursive](getting-started/install-guides/intellij-cursive.md)
    * [Editor User Guide](getting-started/editor-guides/index.md)
        * [Atom ProtoREPL](getting-started/editor-guides/atom-protorepl.md)
        * [Atom Proton](getting-started/editor-guides/atom-proton.md)
        * [Emacs Spacemacs](getting-started/editor-guides/emacs-spacemacs.md)
        * [VSCode Calva](getting-started/editor-guides/vscode-calva.md)
        * [IntelliJ Cursive](getting-started/editor-guides/intellij-cursive.md)
